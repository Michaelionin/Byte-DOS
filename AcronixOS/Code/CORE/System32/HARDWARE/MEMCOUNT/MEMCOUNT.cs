...
namespace AcronixOS.Code.CORE.System32.HARDWARE.MEMCOUNT
{
    public static class MEMCOUNT
    {
        public static void Initialize()
        {
            ...
            {
                Console.WriteLine("[ERROR] OUT OF MEMORY!\nYour system does not have enough RAM to run Byte-DOS!\nAt least 64 Mb of RAM is required, but you only have " + (Cosmos.Core.CPU.GetAmountOfRAM() + 2) + " Mb. Are you an idiot? ");
